...
<div style="position: relative;text-align: center;color: white;">
    ...
    <button style="background-color: black;border-color:#19235e ;padding: 20px;margin:20px;margin-right: 50px;" formaction="adminViewCinema.jsp"><a href="adminViewCinema.jsp" style="color: white;">Enter View Mode</a></button>
    <button style="margin:20px;background-color: black;border-color:#19235e ;padding: 20px;"><a href="updateScheduleCinema.jsp" style="color: white;">Update Schedule</a></button><br>
    <button style="margin:20px;background-color: black;border-color:#19235e ;padding: 20px;"><a href="AddMovie.jsp" style="color: white;">Add Movie</a></button>
    <button style="margin:20px;background-color: black;border-color:#19235e ;padding: 20px;"><a href="DeleteMovie.jsp" style="color: white;">
